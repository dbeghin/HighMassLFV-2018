...
file_OS=ROOT.TFile("../HighMassLFVMuTau/fakerate_factorised_OSMtLow.root","r")
file_SS=ROOT.TFile("../HighMassLFVMuTau/fakerate_factorised_SSMtLow.root","r")
file_DY=ROOT.TFile("../HighMassLFVMuTau/fakerate_factorised_flavorDY.root","r")
...
ends.append("DM11_barrel")
ends.append("DM11_endcap")
...
"DM11_barrel":   "Barrel - DM11",
"DM11_endcap":   "Endcap - DM11",
}
...
for k in range (0,nvar):
    for l in range (0,len(ends)):
        ...
        OS.GetXaxis().SetRangeUser(50,400)
        ...
        OS.SetTitle("")
        OS.GetYaxis().SetTitle("Fake Factor")
        ...
        SS.GetXaxis().SetRangeUser(50,400)
        ...
        SS.SetTitle("")
        SS.GetYaxis().SetTitle("Fake Factor")
        ...
        DY.GetXaxis().SetRangeUser(50,400)
        ...
        DY.SetTitle("")
        DY.GetYaxis().SetTitle("Fake Factor")
