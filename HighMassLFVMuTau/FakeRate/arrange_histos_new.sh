...
#
mkdir -p Arranged_DY
hadd -f Arranged_DY/DY_inclusive.root Out_DYinc*/Con*DY*.root 
...
mkdir -p Arranged_TT
hadd -f Arranged_TT/TT_inclusive.root Out_TT*/Con*TT*.root 
...
mkdir -p Arranged_WW
hadd -f Arranged_WW/WW_inclusive.root Out_WWTo2L*/Con*WW*.root 
...
hadd -f Arranged_data/data.root Out_Data_SMu*/*.root