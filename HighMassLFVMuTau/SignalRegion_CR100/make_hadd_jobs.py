...
if __name__ == "__main__":
    ...
    for jj in range(0, len(pnfn)):    
        ...
        con_name = "Arranged_"+myname[jj]+".root"
        ...
        outFile.close()
        submit_File.write("qsub -q localgrid@cream02 -o remote_"+myname[jj]+".stdout -e remote_"+myname[jj]+".stderr -l walltime="+walltime+"  arrange_histos_"+myname[jj]+".sh\n")
