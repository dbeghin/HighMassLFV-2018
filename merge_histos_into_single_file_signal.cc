...
TH1F* MC_histo_zprime(TString var, TString weightID, TFile* file_in, double xs, int rebin) {
  ...
  double lumi = 59.74 * pow(10,3);

  double w = 0;
  cout << "sumOfPDFWeights_"+weightID << endl;
  TH1F* h_SOWsys = (TH1F*) file_in->Get("sumOfPDFWeights_"+weightID);
  cout << "sumOfPDFWeights_"+weightID << " after" << endl;
...
int main(int argc, char** argv) {
  ...
  vars.push_back("tau_eta_realtau_");        vars_out.push_back("tau_eta_");	    simpleRebin.push_back(true);   reb.push_back(1);  xpoints.push_back(xpoints_pt);	 
  ...
  vars.push_back("mu_eta_realtau_");         vars_out.push_back("mu_eta_");	    simpleRebin.push_back(true);   reb.push_back(1);  xpoints.push_back(xpoints_pt);  	 
